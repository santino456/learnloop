...
Resources 是 server 暴露给 client 的上下文数据。官方 resources 规范说，resource 由 URI 唯一标识，可以代表文件、数据库 schema 或应用特定信息，见 [Resources](https://modelcontextprotocol.io/specification/2025-06-18/server/resources)。
